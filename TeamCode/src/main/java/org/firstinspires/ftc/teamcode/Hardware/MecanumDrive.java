...
*/
    ...
    public void encoderStrafe(LinearOpMode caller,
        ...
        encoderStrafe(caller, speed, leftInches, rightInches,timeoutS, true);
    }
    ...
    public void encoderStrafe(LinearOpMode caller,
                              double speed,
                              double leftInches, double rightInches,
                              double timeoutS, boolean autoCorrect) throws InterruptedException {
        int newLeftFrontTarget;
        int newRightFrontTarget;
        int newLeftBackTarget;
        int newRightBackTarget;
...
//        }
    ...
    public void MecDiagonal (LinearOpMode caller,
        ...
        }while (caller.opModeIsActive() && Seconds > runtime.milliseconds());
